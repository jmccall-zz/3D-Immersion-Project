...
public class FingerControl : MonoBehaviour {
	...
	void Update () {
		...
		adjustJointTilts ("LeftHandIndex1", degrees: Models.fingers[5], knuckle: Models.fingers[9], hand: LEFT);
		adjustJointTilts ("LeftHandMiddle1", degrees: Models.fingers[6], knuckle: Models.fingers[9], hand: LEFT);
		adjustJointTilts ("LeftHandRing1", degrees: Models.fingers[7], knuckle: Models.fingers[9], hand: LEFT);
		adjustJointTilts ("LeftHandPinky1", degrees: Models.fingers[8], knuckle: Models.fingers[9], hand: LEFT);
