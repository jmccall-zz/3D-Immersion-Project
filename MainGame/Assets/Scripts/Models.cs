...
public class Models : MonoBehaviour {
	...
	void Update() {
		...
		try {
			...
			int Index_Finger_Block_0  = reader.rightFingerZones[0];
			int Index_Finger_Block_15 = reader.rightFingerZones[1];
			int Index_Finger_Block_30 = reader.rightFingerZones[2];
			int Index_Finger_Block_45 = reader.rightFingerZones[3];
			int Index_Finger_Block_60 = reader.rightFingerZones[4];	
			int Index_Finger_Block_75 = reader.rightFingerZones[5];
			int Index_Finger_Block_90 = reader.rightFingerZones[6];	
			
			
			////////////////////////middle finger block definitions//////////////
			int Middle_Finger_Block_0  = reader.rightFingerZones[7];
			int Middle_Finger_Block_15 = reader.rightFingerZones[8];
			int Middle_Finger_Block_30 = reader.rightFingerZones[9];
			int Middle_Finger_Block_45 = reader.rightFingerZones[10];
			int Middle_Finger_Block_60 = reader.rightFingerZones[11];
			int Middle_Finger_Block_75 = reader.rightFingerZones[12];
			int Middle_Finger_Block_90 = reader.rightFingerZones[13];
			//////////////////////ring finger block definitions//////////////////
			
			
			int Ring_Finger_Block_0  =  reader.rightFingerZones[14];
			int Ring_Finger_Block_15 =  reader.rightFingerZones[15];
			int Ring_Finger_Block_30 =  reader.rightFingerZones[16];
			int Ring_Finger_Block_45 =  reader.rightFingerZones[17];
			int Ring_Finger_Block_60 =  reader.rightFingerZones[18];
			int Ring_Finger_Block_75 =  reader.rightFingerZones[19];
			int Ring_Finger_Block_90 =  reader.rightFingerZones[20];
			
			
			/////////////////////pinky block definitions////////////////////
			int Pinky_Finger_Block_0  =  reader.rightFingerZones[21];
			int Pinky_Finger_Block_15 =  reader.rightFingerZones[22];
			int Pinky_Finger_Block_30 =  reader.rightFingerZones[23];
			int Pinky_Finger_Block_45 =  reader.rightFingerZones[24];
			int Pinky_Finger_Block_60 =  reader.rightFingerZones[25]; 
			int Pinky_Finger_Block_75 =  reader.rightFingerZones[26];
			int Pinky_Finger_Block_90 =  reader.rightFingerZones[27];
