...
#define ADC_CFG1_CLOCK_FREQ         (518000u)
#define ADC_CFG1_CP_CLOCK_FREQ      (2072000u)
#define ADC_CFG1_REFERENCE_VOLTAGE  (1.2500)
#define ADC_CFG1_COUNTS_PER_VOLT    (8738u)
